...
def build_results_dir(tf_iter, newton_iter, optimizer_name):
    ...
    results_dir = os.path.join(PROJECT_ROOT, "Results", "Helmholtz-NTK", optimizer_folder, run_folder)
...
#Fit helmholtz
parser = argparse.ArgumentParser(description="Train Helmholtz NTK PINN")
parser.add_argument(
    "--optimizer",
